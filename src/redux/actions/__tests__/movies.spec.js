...
import {GET_MOVIES_FAILURE, GET_MOVIES_REQUEST, GET_MOVIES_SUCCESS, loadMovies} from "../movies";
...
describe('load movies action', () => {
    ...
    const result = {
        "data": [{
            ...
            "runtime": 123
        }], "total": 3000, "offset": 0, "limit": 10
    };

    it('creates GET_MOVIES_SUCCESS when fetching has been done', () => {
        fetchMock.getOnce('http://react-cdp-api.herokuapp.com/movies', {
            body: {
                result
            },
        ...
        const expectedActions = [
            ...
            { type: GET_MOVIES_SUCCESS,  payload: result.data }
        ];
        const store = mockStore({payload: result.data} )
